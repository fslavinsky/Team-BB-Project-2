...
public DataWrangleRBT() {
  ...
  public static RedBlackTree<GroceryItem> readCSV(String filePath) {
    try {
      ...
      while (line != null) {
        ...
        GroceryItem item = new GroceryItem(tokens[0], tokens[1], tokens[2], 
            Integer.parseInt(tokens[3])); //create new grocery item with given information
  ...
  /**Takes given informataion provided by the user and inserts a new Grocery Item into the 
   * red black tree
   * 
